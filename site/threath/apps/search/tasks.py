...
def process_search():
    log = logging.getLogger('queued_search')
    log.info("Starting to process the queue.")
    process_obj = ProcessSearchQueue()
    process_obj.handle_noargs(using=DEFAULT_ALIAS)


class ProcessSearchQueue(object):

    def __init__(self, *args, **kwargs):
        super(ProcessSearchQueue, self).__init__(*args, **kwargs)
